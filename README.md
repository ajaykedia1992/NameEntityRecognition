...
In this project, I used Bi directional LSTM using Elmo Encoding. I started using BERT but couldn't complete the code on time and it's need a more learning. Apart from that, pytorch has in built library for BERT but more over, everything needs to be converted to pytorch. You can find information about the BERT on [Google AI Blog](https://ai.googleblog.com/2018/11/open-sourcing-bert-state-of-art-pre.html). 
